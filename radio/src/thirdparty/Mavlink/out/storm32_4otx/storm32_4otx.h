/** @file
 *  @brief MAVLink comm protocol generated from storm32_4otx.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_STORM32_4OTX_H
#define MAVLINK_STORM32_4OTX_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_STORM32_4OTX.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_MESSAGE_CRCS {{62001, 186, 42, 42, 3, 40, 41}, {62002, 69, 32, 32, 3, 30, 31}, {62010, 208, 33, 33, 0, 0, 0}, {62011, 183, 7, 7, 0, 0, 0}, {62012, 99, 36, 36, 3, 32, 33}, {62013, 129, 24, 24, 3, 20, 21}, {62014, 134, 8, 8, 3, 4, 5}, {62015, 78, 22, 22, 3, 0, 1}, {62020, 202, 4, 4, 0, 0, 0}}
#endif

#include "../protocol.h"

#define MAVLINK_ENABLED_STORM32_4OTX
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_DEVICE_STATUS, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_DEVICE_CONTROL, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_INFORMATION, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_STATUS, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_CONTROL, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_CORRECT_ROLL, MAVLINK_MESSAGE_INFO_STORM32_GIMBAL_MANAGER_PROFILE, MAVLINK_MESSAGE_INFO_QSHOT_STATUS}
# define MAVLINK_MESSAGE_NAMES {{ "QSHOT_STATUS", 62020 }, { "STORM32_GIMBAL_DEVICE_CONTROL", 62002 }, { "STORM32_GIMBAL_DEVICE_STATUS", 62001 }, { "STORM32_GIMBAL_MANAGER_CONTROL", 62012 }, { "STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW", 62013 }, { "STORM32_GIMBAL_MANAGER_CORRECT_ROLL", 62014 }, { "STORM32_GIMBAL_MANAGER_INFORMATION", 62010 }, { "STORM32_GIMBAL_MANAGER_PROFILE", 62015 }, { "STORM32_GIMBAL_MANAGER_STATUS", 62011 }}
